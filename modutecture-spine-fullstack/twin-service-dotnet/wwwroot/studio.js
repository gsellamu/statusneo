 ...
 * Split-screen lenses (2D / schematic / 3D / data) all render the SAME GraphQL twin
 * payload and update together. Sync = polling baseline + graphql-ws subscription push.
 * This is the architecture proving itself: the renderer owns nothing; truth is the twin.
 * (Unity and UE5 are real separate windows on the same backend — not in this page.)
 */
