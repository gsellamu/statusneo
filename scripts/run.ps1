...
if (-not $PgConn) { $PgConn = "Host=localhost;Port=5431;Database=modutecture;Username=$PgUser;Password=$PgPassword" }
...
Write-Host "  ECO    : http://localhost:$Port/ecosystem.html (Master AEC Ecosystem Blueprint)"
Write-Host "  AI     : http://localhost:$Port/ai-engine.html (Agentic AI Engine stack)"
